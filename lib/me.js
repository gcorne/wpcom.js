...
Me.prototype.get = function(query, fn){
  this.wpcom.request('/me', query, null, fn);
};
...
Me.prototype.sites = function(query, fn){
  this.wpcom.request('/me/sites', query, null, fn);
};
...
Me.prototype.likes = function(query, fn){
  this.wpcom.request('/me/likes', query, null, fn);
};
...
Me.prototype.groups = function(query, fn){
  this.wpcom.request('/me/groups', query, null, fn);
};
...
Me.prototype.connections = function(query, fn){
  this.wpcom.request('/me/connections', query, null, fn);
};
